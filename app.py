...
def close_app():
    global root  # Make sure 'root' is global
    root.quit()

def setup_ui():
    global root, preview_label  # Declare 'root' and 'preview_label' as global
    root = tk.Tk()
    root.title("Attendance Scanner")
    root.geometry("500x500")
    root.config(bg="#f0f0f0")

    label = tk.Label(root, text="Attendance Scanner", font=("Brittany", 16, "bold"), bg="#f0f0f0", fg="#333")
    label.pack(pady=20)
